...
export const ReportInjury : React.FunctionComponent<Itest> =(props) => { 
  ...
  const [chosenDate, setChosenDate] = useState<Date | null>(null) 
    ...
    const zapiszWBazieTreningi =async()=>{
      ...
      const updatePauseRef = doc(db, "usersData", chosenUserId);
      await updateDoc(updatePauseRef, {
      add: paymentDateIndex -indexOfDate
      })
      .then(()=>console.log("adnotaca kontuzji zrobiona"));
    }
    }
