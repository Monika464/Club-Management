...
{!stopReported && !pausaReported && <p className="title">Jeżeli chcesz zgłosić kontuzję lub chorobe kliknij poniżej</p>}
           ...
           {pausaReported && <p className="titleAlert">Treningi sa zawieszone z powodu kontuzji</p>}
           {!stopReported && pausaReported && <p className="title">Jeżeli chcesz zgłosić powrót kliknij poniżej</p>}
